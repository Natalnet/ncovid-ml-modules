...
glossary_3 = glossary_manner.create_glossary(
    df_araraquara.columns, feat_preset=feature_enum.BaseCollecting.EPIDEMIOLOGICAL
)
print(glossary_3.features_dict)
# {'cases': 'confirmed', 'recovered': None, 'deaths': 'deaths'}

glossary_4 = glossary_manner.create_glossary(
    df_araraquara.columns, feat_preset=feature_enum.BaseCollecting.BASE
)
