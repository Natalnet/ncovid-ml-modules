...
def add_all_configures_to_globals(
    configure_dict: dict
    ) -> None:
    try:
        ...
        logger.error_log("configs_manner.py", "add all variables to globals", f"Error: {e}.")

def add_variable_to_globals(
    var_name: str, 
    value
    ) -> None:
    try:
...
def update_variable_value_in_dictionaries(
    ...
    try:     
        ...
        logger.error_log("configs_manner.py", "uptade variable value in sub-dictionaries", f"Error: {e}.")
...
def combine_configures_names_and_add_to_globals(
    configures_to_combine: dict, 
    desired_new_name: str
    ) -> None:
    ...
    try:
        ...
        logger.error_log("configs_manner.py", "combine configures names and add to globals", f"Error: {e}.")
    
def combine_configures_names(
    configures_to_combine: dict
    ) -> str:
    try:
        ...
        logger.error_log("configs_manner.py", "combine configures names", f"Error: {e}.")
...
with open("../doc/configure.json") as json_file:
    try:
        ...
        combine_configures_names_and_add_to_globals([data_path, model_path], 'model_path')
        combine_configures_names_and_add_to_globals([docs_path, glossary_file], 'glossary_file')                
        
    except Exception as e:
        logger.error_log("configs_manner.py", "loading cofigurations and add to globals", f"Error: {e}.")
